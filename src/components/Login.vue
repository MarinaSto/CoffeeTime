...
<div class="container d-flex justify-content-center align-item-center">
    <div class="wrapper-login d-flex align-self-center flex-column justify-content-around">
        ...
        <form class="form-login">
            ...
            <button class="btn btn-lg btn-info btn-block text-uppercase" v-on:click="login">Login</button>
        </form> 

        <div class="separator"> OR </div>
        <button class="btn btn-lg btn-warning btn-block text-uppercase"><router-link to="/register">Sing Up</router-link></button>
